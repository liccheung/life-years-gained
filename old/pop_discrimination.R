setwd("~/Desktop/Lung cancer/lrisk/other/lifeyearsgained/")
...
load(file="nhis1997_09_even_mod1.RData")
...
save(smokers4080, smokers4080.var, eligible, eligible.var, ineligible4080, ineligible4080.var, file= "auc.RData")
...
aucs <- rbind(
	cbind(smokers4080, smokers4080-1.96*sqrt(smokers4080.var), smokers4080+1.96*sqrt(smokers4080.var)),
	cbind(eligible, eligible-1.96*sqrt(eligible.var), eligible+1.96*sqrt(eligible.var)),
	cbind(ineligible5080, ineligible5080-1.96*sqrt(ineligible5080.var), ineligible5080+1.96*sqrt(ineligible5080.var))
)

row.names(aucs) <- c("Overall 40-80", "Eligible", "Ineligible 40-80")
colnames(aucs) <- c("AUC","Lower95","Upper95")	
