...
load(file="~/Desktop/Lung cancer/lrisk/other/lifeyearsgained/v6/nhis1997_09_even_mod21.RData")
...
load(file="~/Desktop/Lung cancer/lrisk/other/lifeyearsgained/v6/nhis1997_09_even_mod22.RData")
nhis$comorbidities <- nhis$emp+nhis$hypertension+nhis$chd+nhis$angina+nhis$heartattack+
  nhis$heartdisease+nhis$stroke+nhis$diab+nhis$bron+nhis$kidney+
  nhis$liver+nhis$prior.cancer+nhis$speceq
nhis$uspstf.eligible <- ifelse(nhis$age>=55 & nhis$age <= 80 & 
...
load(file="~/Desktop/Lung cancer/lrisk/other/lifeyearsgained/v6/nhis1997_09_even_mod23.RData")
nhis$comorbidities <- nhis$emp+nhis$hypertension+nhis$chd+nhis$angina+nhis$heartattack+
  nhis$heartdisease+nhis$stroke+nhis$diab+nhis$bron+nhis$kidney+
  nhis$liver+nhis$prior.cancer+nhis$speceq
nhis$uspstf.eligible <- ifelse(nhis$age>=55 & nhis$age <= 80 & 
...
load(file="~/Desktop/Lung cancer/lrisk/other/lifeyearsgained/v6/nhis1997_09_even_mod24.RData")
nhis$comorbidities <- nhis$emp+nhis$hypertension+nhis$chd+nhis$angina+nhis$heartattack+
  nhis$heartdisease+nhis$stroke+nhis$diab+nhis$bron+nhis$kidney+
  nhis$liver+nhis$prior.cancer+nhis$speceq
nhis$uspstf.eligible <- ifelse(nhis$age>=55 & nhis$age <= 80 & 
...
load(file="~/Desktop/Lung cancer/lrisk/other/lifeyearsgained/v6/nhis1997_09_even_mod25.RData")
nhis$comorbidities <- nhis$emp+nhis$hypertension+nhis$chd+nhis$angina+nhis$heartattack+
  nhis$heartdisease+nhis$stroke+nhis$diab+nhis$bron+nhis$kidney+
  nhis$liver+nhis$prior.cancer+nhis$speceq
nhis$uspstf.eligible <- ifelse(nhis$age>=55 & nhis$age <= 80 & 
...
write.table(eo_res,"~/Desktop/Lung cancer/lrisk/other/lifeyearsgained/mortality_model6_validation.csv",sep=",")