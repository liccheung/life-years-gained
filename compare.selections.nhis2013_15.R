#differences in selection of USPSTF, Risk-based, and Life-years gained
...
nhis$C1 <- ifelse(nhis$uspstf.eligible==1 & nhis$lyg.eligible==0,1,0)
nhis$C2 <- ifelse(nhis$uspstf.eligible==0 & nhis$lyg.eligible==1,1,0)
nhis$C3 <- ifelse(nhis$uspstf.eligible==1 & nhis$lyg.eligible==1,1,0)
nhis$C4 <- ifelse(nhis$lyg.eligible==0 & nhis$lcrat.eligible==1,1,0)
nhis$C5 <- ifelse(nhis$lyg.eligible==1 & nhis$lcrat.eligible==0,1,0)
nhis$C6 <- ifelse(nhis$lyg.eligible==1 & nhis$lcrat.eligible==1,1,0)
...
master  <- svydesign(id=~psu, strata=~strata, weights=~adj.wt, data=nhis, nest=TRUE)
master <- subset(master, analypop==1 & age>=40 & age <= 80)
c1 <- subset(master,uspstf.eligible==1 & lyg.eligible==0)
c2 <- subset(master,uspstf.eligible==0 & lyg.eligible==1)
c3 <- subset(master,uspstf.eligible==1 & lyg.eligible==1)
c4 <- subset(master,lyg.eligible==0 & lcrat.eligible==1)
c5 <- subset(master,lyg.eligible==1 & lcrat.eligible==0)
c6 <- subset(master,lyg.eligible==1 & lcrat.eligible==1)

mLCRAT0.1 <- svymean(~LCRAT,master) 
mLCRAT1.1 <- svymean(~LCRAT,c1)
mLCRAT2.1 <- svymean(~LCRAT,c2)
mLCRAT3.1 <- svymean(~LCRAT,c3)
mLCRAT4.1 <- svymean(~LCRAT,c4)
mLCRAT5.1 <- svymean(~LCRAT,c5)
mLCRAT6.1 <- svymean(~LCRAT,c6)
...
tabLCRAT4.1 <- svytable(~LCRATcat+C4,master)
tabLCRAT5.1 <- svytable(~LCRATcat+C5,master)
tabLCRAT6.1 <- svytable(~LCRATcat+C6,master)
...
meda.LCRAT.1 <- svyquantile(~age,lcrat,.1)
...
tabss0.1 <- svytable(~current,master)
tabss1.1 <- svytable(~current+C1,master)
tabss2.1 <- svytable(~current+C2,master)
tabss3.1 <- svytable(~current+C3,master)
tabss4.1 <- svytable(~current+C4,master)
tabss5.1 <- svytable(~current+C5,master)
tabss6.1 <- svytable(~current+C6,master)
...
mLCRAT4.2 <- svymean(~LCRAT,c4)
mLCRAT5.2 <- svymean(~LCRAT,c5)
mLCRAT6.2 <- svymean(~LCRAT,c6)
...
tabLCRAT4.2 <- svytable(~LCRATcat+C4,master)
tabLCRAT5.2 <- svytable(~LCRATcat+C5,master)
tabLCRAT6.2 <- svytable(~LCRATcat+C6,master)
...
meda.LCRAT.2 <- svyquantile(~age,lcrat,.2)
...
tabss0.2 <- svytable(~current,master)
tabss1.2 <- svytable(~current+C1,master)
tabss2.2 <- svytable(~current+C2,master)
tabss3.2 <- svytable(~current+C3,master)
tabss4.2 <- svytable(~current+C4,master)
tabss5.2 <- svytable(~current+C5,master)
tabss6.2 <- svytable(~current+C6,master)
...
mLCRAT4.3 <- svymean(~LCRAT,c4)
mLCRAT5.3 <- svymean(~LCRAT,c5)
mLCRAT6.3 <- svymean(~LCRAT,c6)
...
tabLCRAT4.3 <- svytable(~LCRATcat+C4,master)
tabLCRAT5.3 <- svytable(~LCRATcat+C5,master)
tabLCRAT6.3 <- svytable(~LCRATcat+C6,master)
...
meda.LCRAT.3 <- svyquantile(~age,lcrat,.3)
...
tabss0.3 <- svytable(~current,master)
tabss1.3 <- svytable(~current+C1,master)
tabss2.3 <- svytable(~current+C2,master)
tabss3.3 <- svytable(~current+C3,master)
tabss4.3 <- svytable(~current+C4,master)
tabss5.3 <- svytable(~current+C5,master)
tabss6.3 <- svytable(~current+C6,master)
...
mLCRAT4.4 <- svymean(~LCRAT,c4)
mLCRAT5.4 <- svymean(~LCRAT,c5)
mLCRAT6.4 <- svymean(~LCRAT,c6)
...
tabLCRAT4.4 <- svytable(~LCRATcat+C4,master)
tabLCRAT5.4 <- svytable(~LCRATcat+C5,master)
tabLCRAT6.4 <- svytable(~LCRATcat+C6,master)
...
meda.LCRAT.4 <- svyquantile(~age,lcrat,.4)
...
tabss0.4 <- svytable(~current,master)
tabss1.4 <- svytable(~current+C1,master)
tabss2.4 <- svytable(~current+C2,master)
tabss3.4 <- svytable(~current+C3,master)
tabss4.4 <- svytable(~current+C4,master)
tabss5.4 <- svytable(~current+C5,master)
tabss6.4 <- svytable(~current+C6,master)
...
mLCRAT4.5 <- svymean(~LCRAT,c4)
mLCRAT5.5 <- svymean(~LCRAT,c5)
mLCRAT6.5 <- svymean(~LCRAT,c6)
...
tabLCRAT4.5 <- svytable(~LCRATcat+C4,master)
tabLCRAT5.5 <- svytable(~LCRATcat+C5,master)
tabLCRAT6.5 <- svytable(~LCRATcat+C6,master)
...
tabss0.5 <- svytable(~current,master)
tabss1.5 <- svytable(~current+C1,master)
tabss2.5 <- svytable(~current+C2,master)
tabss3.5 <- svytable(~current+C3,master)
tabss4.5 <- svytable(~current+C4,master)
tabss5.5 <- svytable(~current+C5,master)
tabss6.5 <- svytable(~current+C6,master)
...
(mLCRAT4.1+mLCRAT4.2+mLCRAT4.3+mLCRAT4.4+mLCRAT4.5)/5,
(mLCRAT5.1+mLCRAT5.2+mLCRAT5.3+mLCRAT5.4+mLCRAT5.5)/5,
(mLCRAT6.1+mLCRAT6.2+mLCRAT6.3+mLCRAT6.4+mLCRAT6.5)/5),
c(365.35*(mlyg1.1+mlyg1.2+mlyg1.3+mlyg1.4+mlyg1.5)/5,
...
((tabLCRAT3.1+tabLCRAT3.2+tabLCRAT3.3+tabLCRAT3.4+tabLCRAT3.5)/5)[,2],
((tabLCRAT4.1+tabLCRAT4.2+tabLCRAT4.3+tabLCRAT4.4+tabLCRAT4.5)/5)[,2],
((tabLCRAT5.1+tabLCRAT5.2+tabLCRAT5.3+tabLCRAT5.4+tabLCRAT5.5)/5)[,2],
((tabLCRAT6.1+tabLCRAT6.2+tabLCRAT6.3+tabLCRAT6.4+tabLCRAT6.5)/5)[,2])/1000,
...
((tablyg3.1+tablyg3.2+tablyg3.3+tablyg3.4+tablyg3.5)/5)[,2],
((tablyg4.1+tablyg4.2+tablyg4.3+tablyg4.4+tablyg4.5)/5)[,2],
((tablyg5.1+tablyg5.2+tablyg5.3+tablyg5.4+tablyg5.5)/5)[,2],
((tablyg6.1+tablyg6.2+tablyg6.3+tablyg6.4+tablyg6.5)/5)[,2])/1000,
...
((tabg4.1+tabg4.2+tabg4.3+tabg4.4+tabg4.5)/5)[,2],
((tabg5.1+tabg5.2+tabg5.3+tabg5.4+tabg5.5)/5)[,2],
((tabg6.1+tabg6.2+tabg6.3+tabg6.4+tabg6.5)/5)[,2])/1000,
...
((tabr4.1+tabr4.2+tabr4.3+tabr4.4+tabr4.5)/5)[,2],
((tabr5.1+tabr5.2+tabr5.3+tabr5.4+tabr5.5)/5)[,2],
((tabr6.1+tabr6.2+tabr6.3+tabr6.4+tabr6.5)/5)[,2])/1000,
...
((taba4.1+taba4.2+taba4.3+taba4.4+taba4.5)/5)[,2],
((taba5.1+taba5.2+taba5.3+taba5.4+taba5.5)/5)[,2],
((taba6.1+taba6.2+taba6.3+taba6.4+taba6.5)/5)[,2])/1000,
...
((tabc4.1+tabc4.2+tabc4.3+tabc4.4+tabc4.5)/5)[,2],
((tabc5.1+tabc5.2+tabc5.3+tabc5.4+tabc5.5)/5)[,2],
((tabc6.1+tabc6.2+tabc6.3+tabc6.4+tabc6.5)/5)[,2])/1000,
cbind(((tabss1.1+tabss1.2+tabss1.3+tabss1.4+tabss1.5)/5)[,2],
((tabss2.1+tabss2.2+tabss2.3+tabss2.4+tabss2.5)/5)[,2],
((tabss3.1+tabss3.2+tabss3.3+tabss3.4+tabss3.5)/5)[,2],
((tabss4.1+tabss4.2+tabss4.3+tabss4.4+tabss4.5)/5)[,2],
((tabss5.1+tabss5.2+tabss5.3+tabss5.4+tabss5.5)/5)[,2],
((tabss6.1+tabss6.2+tabss6.3+tabss6.4+tabss6.5)/5)[,2])/1000)

colnames(tab4) <- c("USPSTF, not LYG", "LYG, not USPSTF", "LYG and USPSTF",
                    "LCRAT, not LYG", "LYG, not LCRAT", "LCRAT and LYG")
rownames(tab4) <- c("Mean LCRAT","Mean LDG", 
                    "Q1 LCRAT", "Q2 LCRAT", "Q3 LCRAT", "Q4 LCRAT", "Q5 LCRAT",
                    "Q1 LDG", "Q2 LDG", "Q3 LDG", "Q4 LDG", "Q5 LDG",
                    "Males","Females",
                    "Whites","Blacks","Hispanics","Asian or Other",
                    "40-49","50-59","60-69","70-80",
                    "No comorbidities","1 comorbidities","2 comordibities","3+ comordibities",
                    "Former","Current")

write.table(round(tab4,2),"~/Desktop/Lung cancer/lrisk/other/lifeyearsgained/screen_selections.csv",sep=",")