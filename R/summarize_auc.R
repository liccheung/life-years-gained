...
load(file= "auc1.RData")
all1 <- c(smokers4080,smokers4080.var) 
elig1 <- c(eligible,eligible.var)
inelig1 <- c(ineligible4080,ineligible4080.var)

load(file= "auc2.RData")
all2 <- c(smokers4080,smokers4080.var) 
elig2 <- c(eligible,eligible.var)
inelig2 <- c(ineligible4080,ineligible4080.var)

load(file= "auc3.RData")
all3 <- c(smokers4080,smokers4080.var) 
elig3 <- c(eligible,eligible.var)
inelig3 <- c(ineligible4080,ineligible4080.var)

load(file= "auc4.RData")
all4 <- c(smokers4080,smokers4080.var) 
elig4 <- c(eligible,eligible.var)
inelig4 <- c(ineligible4080,ineligible4080.var)

load(file= "auc5.RData")
all5 <- c(smokers4080,smokers4080.var) 
elig5 <- c(eligible,eligible.var)
inelig5 <- c(ineligible4080,ineligible4080.var)
