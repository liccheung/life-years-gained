...
load(file="~/Desktop/Lung cancer/lrisk/other/lifeyearsgained/nhis1997_09_even_mod1.RData")
...
load(file="~/Desktop/Lung cancer/lrisk/other/lifeyearsgained/nhis1997_09_even_mod2.RData")
nhis$comorbidities <- nhis$emp+nhis$hypertension+nhis$chd+nhis$angina+nhis$heartattack+
  nhis$heartdisease+nhis$stroke+nhis$diab+nhis$bron+nhis$kidney+
  nhis$liver+nhis$prior.cancer+nhis$speceq
nhis$death_risk <- as.numeric(sapply(1:nrow(nhis),foo))
...
load(file="~/Desktop/Lung cancer/lrisk/other/lifeyearsgained/nhis1997_09_even_mod3.RData")
nhis$comorbidities <- nhis$emp+nhis$hypertension+nhis$chd+nhis$angina+nhis$heartattack+
  nhis$heartdisease+nhis$stroke+nhis$diab+nhis$bron+nhis$kidney+
  nhis$liver+nhis$prior.cancer+nhis$speceq
nhis$death_risk <- as.numeric(sapply(1:nrow(nhis),foo))
...
load(file="~/Desktop/Lung cancer/lrisk/other/lifeyearsgained/nhis1997_09_even_mod4.RData")
nhis$comorbidities <- nhis$emp+nhis$hypertension+nhis$chd+nhis$angina+nhis$heartattack+
  nhis$heartdisease+nhis$stroke+nhis$diab+nhis$bron+nhis$kidney+
  nhis$liver+nhis$prior.cancer+nhis$speceq
nhis$death_risk <- as.numeric(sapply(1:nrow(nhis),foo))
...
load(file="~/Desktop/Lung cancer/lrisk/other/lifeyearsgained/nhis1997_09_even_mod5.RData")
nhis$comorbidities <- nhis$emp+nhis$hypertension+nhis$chd+nhis$angina+nhis$heartattack+
  nhis$heartdisease+nhis$stroke+nhis$diab+nhis$bron+nhis$kidney+
  nhis$liver+nhis$prior.cancer+nhis$speceq
nhis$death_risk <- as.numeric(sapply(1:nrow(nhis),foo))
...
rownames(eo_res) <- c("Overall","USPSTF-eligible","USPSTF-ineligible",
                      ...
                      "Aged <50","Aged 50-59","Aged 60-69","Aged 70-80",
                      "Male","Female",
...
write.table(eo_res,"~/Desktop/Lung cancer/lrisk/other/lifeyearsgained/mortality_model4_validation.csv",sep=",")